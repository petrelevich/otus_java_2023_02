...
public class ProcessorFailOnEvenSecondsTest {
    ...
    void failExactlyOnEvenSecondsTest() {
        Processor processor = new ProcessorFailsOnEvenSecond(2);
        ...
        assertEquals("Second must be odd", thrown.getMessage());
    }

    @Test
    void doesNotFailOnOddSecondsTest() {
        Processor processor = new ProcessorFailsOnEvenSecond(1);
        Message message = new Message.Builder(1L)
                .field1("field1")
                .field2("field2")
                .field3("field3")
